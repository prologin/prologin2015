...
///
// Nombre de points d'action supplémentaires que coûte la neutralisation pour
// chaque bouclier présent.
//
#define COUT_NEUTRALISATION_BOUCLIER 5

///
// Nombre de points d'action que coûte la mise en place d'un bouclier sur un
// portail sans bouclier.
//
...
///
// Constante de proportionnalité reliant l'aire d'un champ au nombre de points
// qu'il rapporte par tour.
//
