...
\def\ptitle{Noosphère} %% Subject's main title
\def\psubtitle{Vous êtes connecté.} %% Subject's sub title

\def\plogo{prologin2015.pdf} %% Logo
\def\psubjectpicture{image.pdf} %% Picture to be displayed
%% on its own page
