...
{-# LINE 97 "CApi.hsc" #-}
  ...
  {-# INLINE alignment #-}
  peek ptr = do
    ax <- ((\hsc_ptr -> peekByteOff hsc_ptr 0)) ptr
{-# LINE 102 "CApi.hsc" #-}
    ay <- ((\hsc_ptr -> peekByteOff hsc_ptr 4)) ptr
{-# LINE 103 "CApi.hsc" #-}
    return $ CPosition ax ay
  {-# INLINE peek #-}
  poke ptr (CPosition ax ay) = do
    ((\hsc_ptr -> pokeByteOff hsc_ptr 0)) ptr ax
{-# LINE 107 "CApi.hsc" #-}
    ((\hsc_ptr -> pokeByteOff hsc_ptr 4)) ptr ay
{-# LINE 108 "CApi.hsc" #-}
  {-# INLINE poke #-}
...
{-# LINE 145 "CApi.hsc" #-}
  ...
  {-# INLINE alignment #-}
  peek ptr = do
    aextr1 <- ((\hsc_ptr -> peekByteOff hsc_ptr 0)) ptr
{-# LINE 150 "CApi.hsc" #-}
    aextr2 <- ((\hsc_ptr -> peekByteOff hsc_ptr 8)) ptr
{-# LINE 151 "CApi.hsc" #-}
    ajoueur_l <- ((\hsc_ptr -> peekByteOff hsc_ptr 16)) ptr
{-# LINE 152 "CApi.hsc" #-}
    return $ CLien aextr1 aextr2 ajoueur_l
  {-# INLINE peek #-}
  poke ptr (CLien aextr1 aextr2 ajoueur_l) = do
    ((\hsc_ptr -> pokeByteOff hsc_ptr 0)) ptr aextr1
{-# LINE 156 "CApi.hsc" #-}
    ((\hsc_ptr -> pokeByteOff hsc_ptr 8)) ptr aextr2
{-# LINE 157 "CApi.hsc" #-}
    ((\hsc_ptr -> pokeByteOff hsc_ptr 16)) ptr ajoueur_l
{-# LINE 158 "CApi.hsc" #-}
  {-# INLINE poke #-}
...
{-# LINE 199 "CApi.hsc" #-}
  ...
  {-# INLINE alignment #-}
  peek ptr = do
    asom1 <- ((\hsc_ptr -> peekByteOff hsc_ptr 0)) ptr
{-# LINE 204 "CApi.hsc" #-}
    asom2 <- ((\hsc_ptr -> peekByteOff hsc_ptr 8)) ptr
{-# LINE 205 "CApi.hsc" #-}
    asom3 <- ((\hsc_ptr -> peekByteOff hsc_ptr 16)) ptr
{-# LINE 206 "CApi.hsc" #-}
    ajoueur_c <- ((\hsc_ptr -> peekByteOff hsc_ptr 24)) ptr
{-# LINE 207 "CApi.hsc" #-}
    return $ CChamp asom1 asom2 asom3 ajoueur_c
  {-# INLINE peek #-}
  poke ptr (CChamp asom1 asom2 asom3 ajoueur_c) = do
    ((\hsc_ptr -> pokeByteOff hsc_ptr 0)) ptr asom1
{-# LINE 211 "CApi.hsc" #-}
    ((\hsc_ptr -> pokeByteOff hsc_ptr 8)) ptr asom2
{-# LINE 212 "CApi.hsc" #-}
    ((\hsc_ptr -> pokeByteOff hsc_ptr 16)) ptr asom3
{-# LINE 213 "CApi.hsc" #-}
    ((\hsc_ptr -> pokeByteOff hsc_ptr 24)) ptr ajoueur_c
{-# LINE 214 "CApi.hsc" #-}
  {-# INLINE poke #-}
...
{-# LINE 250 "CApi.hsc" #-}
    datas <- ((\hsc_ptr -> peekByteOff hsc_ptr 0)) ptr
{-# LINE 251 "CApi.hsc" #-}
    return $ CLien_array datas length
  {-# INLINE peek #-}
  poke ptr (CLien_array datas length) = do
    ((\hsc_ptr -> pokeByteOff hsc_ptr 8)) ptr length
{-# LINE 255 "CApi.hsc" #-}
    ((\hsc_ptr -> pokeByteOff hsc_ptr 0)) ptr datas
{-# LINE 256 "CApi.hsc" #-}
  {-# INLINE poke #-}
